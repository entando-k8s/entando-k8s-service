...
public class IngressService {
    ...
    public Map<String, Boolean> deletePathFromIngressByEntandoPlugin(EntandoPlugin plugin,
        ...
        links.stream().forEach(link -> {
            final Optional<ServerStatus> serverStatus = link.getStatus().getServerStatus("main");
            String ingressName = serverStatus.flatMap(ServerStatus::getIngressName).orElse(null);
            if (StringUtils.isNotBlank(ingressName)) {
                ...
                Ingress res = editor.removeHttpPath(serverStatus.get().getWebContexts());
    ...
    public static class PathIngressRemover {
        ...
        public Ingress removeHttpPath(Map<String, String> httpPaths) {
            Ingress ingress = null;
            for (String httpPath : httpPaths.values()) {
